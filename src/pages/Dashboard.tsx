  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Fetch recommendations with stock data
              ...
              <Card key={rec.id} className="bg-white/10 backdrop-blur-lg border-white/20">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-white">{rec.stock.symbol}</CardTitle>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex justify-between text-white">
                      ...
                      <span>${rec.stock.current_price}</span>
                    </div>
                    <div className="flex justify-between text-white">
                      <span>Target Price:</span>
                      <span>${rec.target_price}</span>
                    </div>
                    <div className="flex justify-between text-white">
              ...
              <Card key={stock.id} className="bg-white/10 backdrop-blur-lg border-white/20">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className={`flex items-center ${stock.price_change_24h >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                  ...
                  <div className="text-gray-400 text-xs mt-1">{stock.sector}</div>
                </CardContent>
              </Card>
            ))}
          </div>
